    ...
    style={{
      ...
      <div className='max-w-7xl mx-auto px-4'>
        <div className='grid grid-cols-2 md:grid-cols-4 gap-8'>
            <div>
                <h1 className='font-bold text-4xl mb-4'><span className='text-red-500'>Yatra</span>Dos</h1>
                <p className='text-sm'>We are dedicated to making your travel dreams come true with expertly curated tours and unforgettable experiences.</p>
            </div>
        ...
        <div className='mt-8 pt-8 border-t border-gray-700 text-center justify-end text-sm'>
            <p>&copy; {new Date().getFullYear()} <span className='font-semibold'>YatraDos</span>. All rights reserved</p>
        </div>
      </div>
    </footer>
  )
